...
class SA(object):
    ...
    def run(self, alpha):
        ...
        current_energy, current_state = self.generateRandomInitState(check_per_columns)
        ...
        while True:
            ...
            next_energy, next_state = self.generateNextRandomState(current_state, check_per_columns)
    ...
    def generateNextRandomState(self, current_state, check_per_column):
